...
| 前置阅读 | [Python Interface Solver Documentation](../index.md) |
...
6. 更新 [Assets & Builders](assets-builders.md) 和总览速查表。
...
5. 更新 [Assets & Builders](assets-builders.md)。
...
4. 添加 tracker 输出结构测试。
5. 更新 [Visualization Tracker](visualization.md)。
...
- `docs/src/examples/interop/python/index.md`：总览、速查表或二次开发流程。
