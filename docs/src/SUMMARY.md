...
* [Examples](examples/index.md)
  ...
  * [Language interop](examples/interop/index.md)
    ...
    * [Python](examples/interop/python/index.md)
      * [Getting Started](examples/interop/python/getting-started.md)
      * [Concepts](examples/interop/python/concepts.md)
      * [Internals](examples/interop/python/internals.md)
        * [Assets & Builders](examples/interop/python/internals/assets-builders.md)
        * [Visualization Tracker](examples/interop/python/internals/visualization.md)
        * [Development Guide](examples/interop/python/internals/development.md)
      * [VRP Studio](examples/interop/python/vrp-studio.md)
